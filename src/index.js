...
if (!document.getElementById('popup')) {
    ...
    $('body').attr('style', function (i, s) {
        return (s || '') + 'top: 96px !important;position: absolute !important;left: 0px !important;right: 0px !important;min-height: calc(100% - 96px) !important;overflow-x: initial !important;';
    });
